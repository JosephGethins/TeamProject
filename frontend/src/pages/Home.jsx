      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 mb-8 border border-white/20">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-blue-200 text-lg">{formatDate()}</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div 
            ...
            className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 backdrop-blur-xl rounded-2xl p-6 border border-cyan-300/30 hover:scale-105 transition-transform cursor-pointer"
          >
            <div className="flex items-center justify-between mb-3">
          ...
          <div 
            ...
            className="bg-gradient-to-br from-blue-400/20 to-blue-500/20 backdrop-blur-xl rounded-2xl p-6 border border-blue-300/30 hover:scale-105 transition-transform cursor-pointer"
          >
            <div className="flex items-center justify-between mb-3">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-blue-200">View your weekly schedule</p>
            </div>
            <button
              onClick={() => navigate('/edit-timetable')}
              className="px-6 py-3 bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-500 hover:to-blue-600 rounded-xl font-semibold text-white shadow-lg transition flex items-center gap-2"
            >
              Edit Timetable
            </button>
          </div>
          ...
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-blue-200 mb-6">Get started by adding your classes to the timetable</p>
              <button
                onClick={() => navigate('/edit-timetable')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div 
            onClick={() => navigate('/quiz')}
            className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 backdrop-blur
-xl rounded-2xl p-6 border border-cyan-300/30 hover:scale-105 transition-transform cursor-pointer">
            <div className="flex items-start gap-4">
              <div className="bg-cyan-400/30 p-3 rounded-xl">
              ...
              <div>
                ...
                <p className="text-cyan-200">Test your knowledge with a quick practice session</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200">Customize your profile and settings</p>
              </div>
            </div>
          </div>
        </div>
